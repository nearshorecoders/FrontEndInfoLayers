...
ClusterIcon.prototype.onAdd = function() {
	...
	google.maps.event.addDomListener(this.div_, "click", function(e) {
		...
		if (!cDraggingMapByCluster) {
			...
			//console.log(mc.getMap().getZoom());
			//console.log(mc.getMaxZoom());
			var o = cClusterIcon.cluster_.getMarkers();
			//console.log(o);
...
MarkerClusterer.prototype.onRemove = function() {
	...
	// Volver a poner todos los marcadores gestionados en el mapa:
	...
	// Eliminar los oyentes de eventos de mapa:
